...
data_dir = '/content/gdrive/MyDrive/ML2024/plant_seedlings_classification/' # dataset's dir you want to unzip

if not os.path.exists(data_dir):
  zip_dir = '/content/gdrive/MyDrive/ML2024/plant_seedlings_classification/' # your zip file's dir
